...
$meal_pricing_three_items = explode( "\n", $meal_pricing_meta['plan-three-items'] );
get_header();
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered price-plan">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><?php echo esc_html( $meal_pricing_meta['plan-three-title'] ); ?></th>
                                            </tr>
                                            </thead>
                                            <tbody>
											<?php
											...
											foreach ( $meal_pricing_items as $meal_pricing_item ):
                                                ...
                                                $meal_plan_three_data = apply_filters('meal_pricing_item',$meal_pricing_three_items[ $meal_counter ]);
												?>
                                                <tr>
                                                    ...
                                                    <td><?php echo wp_kses_post( $meal_plan_three_data ); ?></td>
                                                </tr>
												<?php
												$meal_counter ++;
											endforeach;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo esc_url( $meal_pricing_meta['plan-three-action'] ); ?>"
                                                       class="btn btn-danger">
	                                                    <?php _e( 'Get This Plan', 'meal' ); ?>
                                                    </a>
                                                </td>
